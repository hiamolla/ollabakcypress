describe('example to-do app', () => {
    ...
    it('Verify the user is able to reset password', () => {
        ...
        cy.get('#input-email').should('exist').should('be.visible').type('codelanguage@gmail.com')
        cy.get('#input-password').should('exist').should('be.visible').type('@olabak')
        cy.contains('Forgotten Password').click()
        cy.get('#input-email').should('exist').should('be.visible').type('codelanguage101@gmail.com')
